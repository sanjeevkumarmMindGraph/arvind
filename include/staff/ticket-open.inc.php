 ...
 <table class="form_table fixed" width="940" border="0" cellspacing="0" cellpadding="2">
    ...
    <tbody>
                ...
                <select name="source">
                    ...
                    foreach ($sources as $k => $v)
                        echo sprintf('<option value="%s" %s>%s</option>',
                                ...
                                $v)          
                                //added ticket type change no 39//
                    ?>
                </select>
        ...
        <tr>
            ...
            <td>
                <select name="tckttype">
                    <?php
                    $tckttype = $info['tckttype'] ?: 'Phone';
                    $alltickettypes = Ticket::getAlltickettypes();
                    unset($alltickettypes['Web'], $alltickettypes['API']);
                    foreach ($alltickettypes as $k => $v)
                        echo sprintf('<option value="%s" %s>%s</option>',
                                $k,
                                ($tckttype == $k ) ? 'selected="selected"' : '',
                                $v)          
                    ?>
                </select>
                &nbsp;<font class="error"><b>*</b>&nbsp;<?php echo $errors['tckttype']; ?></font>
            </td>
        </tr>
        <tr>
            <td width="160" class="required">
